...
export async function generateK1PDF(k1Data: K1Data, firmName: string = 'Investment Manager'): Promise<Buffer> {
...
function addFooter(doc: PDFKit.PDFDocument, k1Data: K1Data, firmName: string) {
  // Check if we need a new page
  if (doc.y > 680) {
    doc.addPage()
  }
  ...
  doc.text(`Generated by ${firmName}`, 40, footerY + 25, { width: 532, align: 'center' })
