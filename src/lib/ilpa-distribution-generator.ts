...
export async function generateILPADistributionTemplate(distribution: Distribution, firmName: string = 'Investment Manager'): Promise<Buffer> {
  ...
  footerCell.value = `Generated by ${firmName} on ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}`
