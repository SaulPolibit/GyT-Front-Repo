      ...
      if (data.success && data.data) {
        ...
        const loadedStructure: Structure = {
          ...
          legalTerms: {
            ...
            limitedPartnerRights: Array.isArray(apiStructure.limitedPartnerRights) ? apiStructure.limitedPartnerRights : [],
            limitedPartnerObligations: Array.isArray(apiStructure.limitedPartnerObligations) ? apiStructure.limitedPartnerObligations : [],
            votingThreshold: apiStructure.votingThreshold,
            mattersRequiringConsent: Array.isArray(apiStructure.mattersRequiringConsent) ? apiStructure.mattersRequiringConsent : [],
            lockUpPeriod: apiStructure.lockUpPeriod,
            withdrawalConditions: Array.isArray(apiStructure.withdrawalConditions) ? apiStructure.withdrawalConditions : [],
            withdrawalProcess: Array.isArray(apiStructure.withdrawalProcess) ? apiStructure.withdrawalProcess : [],
            transferProhibition: apiStructure.generalProhibition,
            permittedTransfers: Array.isArray(apiStructure.permittedTransfers) ? apiStructure.permittedTransfers : [],
            transferRequirements: Array.isArray(apiStructure.transferRequirements) ? apiStructure.transferRequirements : [],
            ...
            additionalCommunications: Array.isArray(apiStructure.additionalCommunications) ? apiStructure.additionalCommunications : [],
            liabilityProtection: apiStructure.limitedLiability,
            liabilityExceptions: Array.isArray(apiStructure.exceptionsLiability) ? apiStructure.exceptionsLiability : [],
