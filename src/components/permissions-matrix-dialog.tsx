...
export function PermissionsMatrixDialog({ open, onOpenChange }: PermissionsMatrixDialogProps) {
  const adminPerms = getPermissionsForRole(1) // Admin
  const opsPerms = getPermissionsForRole(2) // Operations
  const roPerms = getPermissionsForRole(4) // Read-Only
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Each role has specific permissions. For example, only Admins can modify settings and delete resources,
            while Operations users focus on capital calls and distributions.
          </DialogDescription>
        </DialogHeader>
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Structures</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Investors */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Investors</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Investments */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Investments</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Capital Operations */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Capital Operations</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Reports */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Reports</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Documents */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Documents</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Chat */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Chat</TableCell>
            </TableRow>
            <TableRow>
            ...
            {/* Settings */}
            <TableRow className="bg-muted/50">
              <TableCell colSpan={4} className="font-semibold">Settings</TableCell>
            </TableRow>
            <TableRow>
